# [I. Контрольная по ударениям](https://contest.yandex.ru/contest/27665/problems/I/ "Ссылка на сайт с задачей")
...
| Ввод | Вывод |
| -|-|
| 4</br>cAnnot</br>cannOt</br>fOund</br>pAge</br>thE pAge cAnnot be found</br> | 2 |
| 4</br>cAnnot</br>cannOt</br>fOund</br>pAge</br>The PAGE cannot be found</br> | 4 |
